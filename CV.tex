...
Thesis: Short-term Human Motion Prediction for Robot Navigation (CrowdBot)\\
...
%	\item [] \textbf{Journal and Conference Reviews:}	
	...
	\item \textbf{Reviewer} @ \textit{IROS-2021} (4 papers)
...
\item Occasional Blogging about AI, Tech, and Society on Instagram and Telegram
\item Hobby photography and videography
\item Interested in football (soccer), hiking (if there is some mountain around), and power-lifting, and also supporting my favorite club: F.C. Perspolis club (Iran). 
