...
\address{{\bf Address} \\ 154 Rue des Blains \\
	 92220 Bagneux, Grand Paris, France } % Your address 1
...
\vspace{8pt} % Gap between title and text
$\bullet$ \textbf{\textit{PhD Candidate} in Robotics and Artificial Intelligence} \hfill Jan. 2018 - Jul 2021\\
...
\item {\bf Amirian, J.}, Hayet, J. B., Pettré, J., {\bf ''What we see and What we don’t see: Imputing Occluded Crowd Structures from Robot Sensing,''} International Conference on Intelligent Robots and Systems (\textbf{Preprint-2021}).

\item Zhang, B., \textbf{Amirian, J.} Eberle, H., Pettr\'e, J., Holloway, C., Carlson , T. \textbf{"Towards Safe Human-Robot Interactions in Crowds: Empirical Study of Pedestrian Dynamics with a Wheelchair and a Pepper Robot."} International Journal of Social Robotics (\textbf{SORO-2021}).
